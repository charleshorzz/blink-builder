  ...
  return (
    <div className="min-h-screen flex flex-col animated-bg">
      ...
      <div className="container mx-auto pt-32 px-4 pb-20">
        <h1 className="text-4xl font-bold mb-4 text-center text-gradient">Simple, transparent pricing</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          <div className="border border-white/10 rounded-lg p-6 backdrop-blur-md">
            ...
            <ul className="space-y-4 mb-8">
              {["3 projects", "Basic templates", "Community support"].map((feature, i) => (
                <li key={i} className="flex items-center">
                  <Check size={18} className="mr-2 text-builder-accent" /> {feature}
                </li>
              ))}
            </ul>
          ...
          <div className="border-2 border-builder-accent rounded-lg p-6 backdrop-blur-md relative">
            ...
            <p className="text-4xl font-bold mb-6">$29<span className="text-muted-foreground text-sm font-normal">/month</span></p>
            <hr className="border-white/10 mb-6" />
            <ul className="space-y-4 mb-8">
              {[
                "Unlimited projects", 
            ...
            <Button className="w-full bg-builder-accent hover:bg-builder-accent/80">Buy Pro</Button>
          </div>

    ...
    <div className="min-h-screen flex flex-col animated-bg">
      ...
      <div className="container mx-auto pt-32 px-4">
        ...
        <div className="prose prose-invert max-w-3xl">
          ...
          <h2>Components</h2>
          <p>
            Our drag and drop builder includes a wide range of Web3 components
            that can be customized to build your application.
          </p>

          <h2>Deployment</h2>
          <p>
            Once your application is ready, you can deploy it with a single
            click. We provide a shareable link that you can distribute to your
            users.
          </p>
        </div>
      </div>

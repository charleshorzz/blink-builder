...
const VotingTemplate: React.FC<VotingTemplateProps> = ({ customizable = false, onCustomize }) => {
  ...
  return (
    <Card className="w-full max-w-md mx-auto backdrop-blur-sm bg-card/80 border-white/10">
      <CardHeader>
        ...
        <CardDescription>Cast your vote on this community proposal</CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        <div>
          <h3 className="text-lg font-medium mb-2">Proposal: Community Treasury Allocation</h3>
          <p className="text-sm text-muted-foreground mb-4">
            How should we allocate the 1000 ETH in the community treasury for Q3?
          </p>

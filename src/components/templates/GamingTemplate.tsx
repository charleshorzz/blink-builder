...
const GamingTemplate: React.FC<GamingTemplateProps> = ({ customizable = false, onCustomize }) => {
  return (
        ...
        <Tabs defaultValue="popular" className="w-full">
          ...
          <TabsContent value="popular" className="pt-4">
            <div className="grid grid-cols-2 gap-4">
              {[
                {name: "Crypto Raiders", players: "2.5K", rewards: "0.05 ETH"},
                ...
                <div key={i} className="border border-white/10 rounded-lg overflow-hidden hover-effect">
                  <div className={`h-20 bg-gradient-to-br ${
                    i % 2 === 0 ? 'from-indigo-500/20 to-purple-500/20' : 'from-purple-500/20 to-pink-500/20'
                  }`}></div>
                  <div className="p-3">
                    ...
                    <Button size="sm" variant="secondary" className="w-full mt-2 text-xs">
                      Play Now
                    </Button>
                  </div>
                </div>
          ...
          <TabsContent value="my-games" className="pt-4">
            <div className="text-center py-8">
              <p className="text-sm text-muted-foreground">Connect your wallet to view your games</p>
          ...
          <TabsContent value="rewards" className="pt-4">
            <div className="text-center py-8">
              <p className="text-sm text-muted-foreground">
                Complete quests and earn rewards by playing games in our ecosystem
              </p>
              <div className="mt-4 bg-muted/50 rounded-lg p-4">
                <p className="text-sm font-medium">Total Rewards Available</p>
                <p className="text-xl font-bold text-builder-accent mt-1">2.5 ETH</p>
              </div>
            </div>
          </TabsContent>
        </Tabs>
